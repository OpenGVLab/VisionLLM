...
class MultipleChoiceDataset(Dataset):
    def __init__(self, name, root, annotation, tokenizer, data_args):
    ...
    def __getitem__(self, idx):
        ...
        img_metas['index'] = data['question_id']
...
def eval_model(args):
    ...
    for ds_name in args.datasets:
        ...
        if torch.distributed.get_rank() == 0:
            ...
            cmd = f'python3 visionllmv2/eval/seed/calculation.py --image_result_file {output_path}'
            os.system(cmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', type=str, default=['SEEDv1'], nargs='+')
