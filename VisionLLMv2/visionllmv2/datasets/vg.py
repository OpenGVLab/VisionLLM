...
class VisualGenome(CocoDataset):
    CLASSES = ('object',)
    ...
    def load_annotations(self, ann_file):
        ...
        self.cat2label = {cat_id: i for i, cat_id in enumerate(self.cat_ids)}  # not used
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get('iscrowd', False):
                ...
                gt_labels.append(ann['caption'])  # caption, GRiT train 350w+
    ...
    def preprocess_data(self, data_item):
        ...
        conversations = []
        # question
        question_template = FINAL_QUESTIONS[0] if self.test_mode else random.choice(FINAL_QUESTIONS)
