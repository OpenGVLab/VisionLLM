...
class ReasonsegLlavaDataset(CocoDataset):
    """
    Return both chat data and reasonseg grounding data.
    """
    CLASSES = ('object',)
    ...
    def __init__(self,
        ...
        train_pipeline = [
            dict(type='LoadImageFromFile', clean_expression=False),
    ...
    def __getitem__(self, idx):
        ...
        # question
        # NOTE: expression and explanation are complete sentence during data preprocessing.
        ...
        if not self.test_mode: # train
            explanation = data_item['img_metas'].data['answer']
